...
<body>
    ...
    <div class="container block">
        ...
        <div class="text-center">
            ...
            <b><h1 class="guard"><span><b><i class="fas fa-user mr-3"></i>Slot Shop Reservation</b></span>
            </h1>
            </b>
            <br>
        </div>
        <div class="d-flex justify-content-around flex-column flex-sm-column flex-md-row flex-lg-row flex-xl-row rounded mx-auto d-block">
            <div class="card item1 border border-dark p-4">
                <img src="https://cdn.iconscout.com/icon/free/png-512/laptop-user-1-1179329.png" class="card-img-top rounded mx-auto d-block mybarcodeimage" alt="...">
                <div class="card-body Shop">
                    <h4 class="card-title shopname">User Count</h4>
                    
                    <h4 class="card-title date">Date</h5>
                    <h4 class="card-title time">Time</h5>
            ...
            <div class="card item2 border border-dark p-4">
                ...
                <div class="card-body Shop">
                    ...
                    <h4 class="card-title date">Date</h5>
                    <h4 class="card-title time">Time</h5>
                     <h5 class="card-title Uniqueid">Unique Code</h5><br><br><br>
                </div><br><br><br>
            </div>
            <br><br><br>
        ...
        <div class="container block">
            ...
            <div class="text-center">
                ...
                <b><h1 class="guard"><span><b><i class="fas fa-user mr-3"></i>Slot Store Reservation</b></span>
                </h1>
                </b><br>
            </div>
            <div class="d-flex justify-content-around flex-column flex-sm-column flex-md-row flex-lg-row flex-xl-row rounded mx-auto d-block">
