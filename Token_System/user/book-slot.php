    ...
    <div class="container-sm " >
      ...
      function myFunction3() { 
        ...
        <div class="scam">
                ...
                <div class="card-header shadow-sm bg-light">
                  ...
                  <div class="card-body">
                    <form action="#">
                      <div class="row">
                        <div class="col-md-10">
                          <button type="button" value="1" id="qr" onclick="generate();return false;" class="btn btn-secondary   mr-5 p-2" >Tap To Generate Qr Code</button>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div id="qrResult" class="qrResult" style="height:200px;width: 200px">
	       </div>
        <script type="text/javascript">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <span class="close">&times;</span>
            <h2>Congratulations!!! You Have Been Successfully Alloted.</h2>
    </div>
  <div class="modal-body">
        <button type="button" value="1" id="qr" onclick="generate();return false;" class="btn btn-primary   mr-5 p-2" >Tap To Generate Qr Code</button>
    </div>
  </div>
 </div>
</div>
