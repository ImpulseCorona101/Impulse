...
<div class="container">
    <div class="text-left"><h3 class="mt-2">Your Transactions </h3><hr style="margin-top:-0.5%" ></div>
    <table class="table">
    <thead>
        <th>Farmer Name</th>
        <th>Phone</th>
    ...
    <tbody>
        <tr>
            <td data-label="Farmer name">Ansh</td>
            <td data-label="Phone">9819104641</td>
            <td data-label="Address">Raj uday </td>
            <td data-label="Product">Ramlal wheat</td>
            <td data-label="Quantity">1</td>
            <td data-label="Delivary mode">Courier</td>
            <td data-label="Payment mode">paytm</td>
...
<button type="button" class="btn  btn-lg border border-dark" style="background-color:#FFD700;color:black;">Continue Shopping<i class="fas fa-shopping-bag ml-2" aria-hidden="true"></i></button>
</div>
