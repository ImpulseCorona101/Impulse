...
<main class="my-form">
		<div class="cotainer">
			<div class="row justify-content-center">
				<div class="col-md-8">
					<div class="card">
						<div class="card-header"><h4 style="font-style:bold;">Login</h4></div>
						<div class="card-body">
							<form name="my-form" action="FarmerLogin.php" method="post">
								...
								<br>
								<div class="col-md-6 offset-md-4">
									<label id="forgotPassword"><a id='link' href="FarmerForgotPassword.php">Forgot your password ?</a></label>
									<br>
									<label id="account"><a id='link' href="FarmerRegister.php">Create New Account</a></label>
								</div>
							</form>
						</div>
					</div>
